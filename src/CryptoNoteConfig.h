...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xc2db5da; // addresses start with "dcoin"
...
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V1         = DIFFICULTY_TARGET * 2;
...
const uint32_t UPGRADE_HEIGHT_V5                             = 7; // Block v5, back to LWMA1+
...
const char     DNS_CHECKPOINTS_HOST[]                        = "checkpoints.deocoin.world";
...
const char* const SEED_NODES[] = { 
  "seed1.deocoin.com:32347",
  "seed2.deocoin.com:32347",
