![Build check](https://github.com/seredat/deocoin/workflows/Build%20check/badge.svg)
...
**HARDFORK V4 IS SET AT HEIGHT 266000!!!** In this hardfork _we introduce adaptive minimal transaction fee_ as first step towards our goal. Information for exchanges and other services how to work with new fees: https://github.com/seredat/deocoin/wiki/Dynamic-transaction-minimum-fee
...
git clone https://github.com/seredat/deocoin.git
cd deocoin
mkdir build
cd build
cmake ..
